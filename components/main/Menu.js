      ...
      <React.Fragment>
        ...
        >
          ...
          <div className="p-5 w-full overflow-y-scroll">
            <h3 className="mb-4 text-2xl font-bold"><a className="mt-2" href="https://www.aa-consultingengineers.com/project/smarttrafficanalysis.php/" target="_blank">Smart Traffic Analysis</a></h3>
            <Toggle
              label="Compteur"
            ...
            <Toggle
              label="Tracker"
              description="Afficher les trajectoires et les positions"
            ...
            />
            <Toggle
              label="Tracker précision"
              description="Afficher les précisions des trackers"
            ...
            <Toggle
              label="Mode sombre"
              description="Activer les éléments d'interface utilisateur sombres"
            ...
            <div className="mb-4 mt-4 flex items-center justify-between">
              <div className="mr-3">
                ...
                <p className="text-xs">Opacité image de la caméra</p>
              </div>
              <div className="flex">
                <button
          ...
          <div className="menu-footer bg-black text-white p-5 w-full">
              <div className="flex flex-col">
                  <a className="" href="#">Apropos</a>
                  <a className="mt-2" target="_blank" href="/api/doc">Documentation</a>
                  <a className="mt-2" href="https://aa-consultingengineers.com/" target="_blank">AAConsulting</a>
              </div>
          </div>
        </div>
        <style jsx>{`
